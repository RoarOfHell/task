...
namespace Task.Connector.Tests
{
    public class UnitTest1
    {
        ...
        static string mssqlConnectionString = "Server=localhost;Database=testDb;Integrated Security=True;TrustServerCertificate=True;";
        //Server=DESKTOP-4K7AP5Q;Database=testDb;Trusted_Connection=True;TrustServerCertificate=True;
        ...
        public IConnector GetConnector(string provider)
        {
            ...
            connector.Logger = new FileLogger($"{DateTime.Now.ToString("yyyy-MM-dd_HH-mm-ss")}connector{provider}.Log", $"{DateTime.Now}connector{provider}");
            return connector;
        }
